...
def main(username=None,groupname=None):
	...
	print("USAGE: python Chump.py <IP> <Port>")
	print("EXAMPLE: python Chump.py localhost 8000\n\n")
	...
	state["username"] = username if username else input("Welcome to PyChat! Please enter your username: ")
	state["groupname"] = groupname if groupname else input("Please enter the name of the group: ")
	state["alive"] = False
